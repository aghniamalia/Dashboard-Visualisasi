...
var style_RatarataPengeluaranPerKapitaMakanan_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Rata-rata Pengeluaran Per Kapita Makanan");
    ...
    if (value >= 456234.000000 && value <= 661983.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 661983.000000 && value <= 887415.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 887415.000000 && value <= 1187989.000000) {
            style = [ new ol.style.Style({
