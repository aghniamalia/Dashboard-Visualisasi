...
var style_PrevalensiBalitaStunting_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Stunting-2023");
    ...
    if (value >= 0.000000 && value <= 20.000000) {
        ...
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(198,219,239,1.0)'}),
